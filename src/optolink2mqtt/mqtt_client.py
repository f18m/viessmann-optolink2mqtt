...
class MqttClient:
    ...
    def __init__(self,
        ...
        self._mqttc.will_set(self.get_optolink2mqtt_status_topic(), payload=MqttClient.LAST_WILL_PAYLOAD, qos=0, retain=True)
        return
    ...
    def on_connect(self, mqttc: paho.Client, userdata: Any, flags: paho.ConnectFlags,
        ...
        # update our status:
        self._mqttc.publish(self.get_optolink2mqtt_status_topic(), MqttClient.NEW_CONN_PAYLOAD, qos=self.qos, retain=True)
